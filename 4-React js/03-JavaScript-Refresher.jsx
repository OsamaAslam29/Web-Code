...
// Two ways to add JavaScript In HTML:
//                               Using <script> Tag : Adding <script></script> tag and writing our JS code inside it.
// External File : 
//                 Adding a File with .js extension through link.The syntax is <script src = “js/tut2.js”></script>
// Variables in JavaScript:
//                           Variables are the memory location to store data. To declare a variable in       Javascript, 
...
// function hello(){
//     console.log("Hey! I am osamaa. ");
// }
// On calling the above function by its name it will print “Hey! I am osamaa.” in the console. 
...
// Accessing element: 
//                     To access the value of ‘m’ we will use obja.m
// Calling function from the objects:
//                                   We can pass any number in the function, suppose 45. To call this function we can similarly use obja.func(45).
...
// break and continue:
// continue:    
//           At a certain condition being met, It skips the current iteration and jumps to the second value.
// break:
//       It stops the iteration when a certain condition is met.
