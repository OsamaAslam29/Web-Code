...
// In this video, we will enhance our textUtils application. Earlier we have enabled dark mode in our about component but this time we will be applying dark mode to our complete application, That is we will learn about how to manage the state of our complete application from "app.js".

// In app.js:
// In our app.js we will create a new state

// const[Mode, setMode] = useState('light');
// Here, by default light mode State is used and We would like to pass this mode to our Navbar component
